    ...
    <div class="card">
        <div class="card-body">
            <div>
                <div class="row">
                    <div class="col-3">
                        <form class="navbar-form navbar-left" role="search" action="<?php echo site_url('input/');?>"
                            method="post">
                    ...
                    <div class="col-3">
                        ...
                        <a href="<?php echo site_url('input/v_index');?>" class="btn btn-success btn-sm"><i
...
$(document).ready(function() {
    setTimeout(function() {
        ...
        $(".xform-lg").on("submit", (function(b) {
            ...
            var a;
            if (simpan == "tambah") {
                a = "<?php echo base_url();?>Input/add";
            } else {
                a = "<?php echo base_url();?>Input/update";
            }
            $.ajax({
                url: a,
                type: "POST",
...
function tambah() {
    ...
    $(".form")[0].reset();
    $("#modal-lg").modal("show");
    $("#modalbody-lg").load("<?php echo base_url();?>Input/modal/", function(a) {
        $("#modalbody-lg").html(a)
    })
}
...
function ganti(a) {
    ...
    $(".form")[0].reset();
    $("#modal-lg").modal("show");
    $("#modalbody-lg").load("<?php echo base_url();?>Input/edit/" + a, function(b) {
        $("#modalbody-lg").html(b)
    })
}
...
function hapus(a) {
    Swal.fire({
        ...
        if (result.value == true) {
            $.get("<?php echo base_url()?>Input/delete/" + a, function(b) {
                location.reload();
            })
        }
    })
