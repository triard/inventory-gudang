...
$(document).ready(function () {
	setTimeout(function() {
		...
		$(".xform").on("submit", (function (b) {
			...
			var a;
			if (simpan == "tambah") {
				a = "<?php echo base_url();?>supplier/add"
			} else {
				a = "<?php echo base_url();?>supplier/update"
			}
			$.ajax({
				url: a,
				type: "POST",
...
function tambah() {
	...
	$(".form")[0].reset();
	$("#myModal").modal("show");
	$("#modalbody").load("<?php echo base_url();?>supplier/modal/", function (a) {
		$("#modalbody").html(a)
	})
}
...
function ganti(a) {
	...
	$(".form")[0].reset();
	$("#myModal").modal("show");
	$("#modalbody").load("<?php echo base_url();?>supplier/edit/" + a, function (b) {
		$("#modalbody").html(b)
	})
}
...
function hapus(a) {
	Swal.fire({
	  ...
	  if (result.value == true) {
		$.get("<?php echo base_url()?>supplier/delete/" + a, function (b) { location.reload(); })
	  }
	})
};
</script>
