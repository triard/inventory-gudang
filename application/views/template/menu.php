...
<header class="header" style="background-color: #ED4C67;">
    ...
    <div class="header__logo hidden-sm-down">
        <h1><a href="<?php echo base_url();?>"><i class="fas fa-warehouse fa-1x  "></i> Inventory</a></h1>
    </div>
</header>
<aside class="sidebar">
    <div class="scrollbar-inner">
        ...
        <ul class="navigation">
            ...
            <li class="navigation__sub">
                <a data-toggle="collapse" href="#xmod1" role="button" aria-expanded="false" aria-controls="xmod1"><i class="fas fa-fire"></i>
